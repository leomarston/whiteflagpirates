...
export const SHIP_TYPES = {
  sloop: {
    ...
    freeboard: 1.9, maxSpeed: 9.5, turnRate: 0.55, hullMax: 100,
  ...
  cutter: {
    ...
    freeboard: 1.6, maxSpeed: 10.2, turnRate: 0.62, hullMax: 80,
  ...
  frigate: {
    ...
    freeboard: 3.4, maxSpeed: 7.8, turnRate: 0.3, hullMax: 320,
  ...
  galleon: {
    ...
    freeboard: 4.4, maxSpeed: 6.4, turnRate: 0.22, hullMax: 460,
    cannonsPerSide: 12, cargoCapacity: 200, crewMax: 40, masts: 3,
    cost: 14000, accel: 0.5,
