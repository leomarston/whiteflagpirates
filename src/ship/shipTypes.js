...
export const SHIP_TYPES = {
  sloop: {
    ...
    freeboard: 1.9, maxSpeed: 15.5, turnRate: 0.85, hullMax: 100,
  ...
  cutter: {
    ...
    freeboard: 1.6, maxSpeed: 16.5, turnRate: 0.95, hullMax: 80,
  ...
  brig: {
    ...
    freeboard: 2.5, maxSpeed: 13.5, turnRate: 0.62, hullMax: 180,
  ...
  merchantman: {
    ...
    freeboard: 3.0, maxSpeed: 11.0, turnRate: 0.46, hullMax: 220,
  ...
  frigate: {
    ...
    freeboard: 3.4, maxSpeed: 12.5, turnRate: 0.46, hullMax: 320,
  ...
  galleon: {
    ...
    freeboard: 4.4, maxSpeed: 10.5, turnRate: 0.34, hullMax: 460,
